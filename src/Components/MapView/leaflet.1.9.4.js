	...
	var mt = {
		...
		A = it.extend({
				...
				return (
					...
					(t = m(t).round()).x || t.y
						? (!0 === e.animate || this.getSize().contains(t)
							? (this._panAnim || ((this._panAnim = new Fe()), this._panAnim.on({ step: this._onPanTransitionStep, end: this._onPanTransitionEnd }, this)),
			...
			flyTo: function (n, o, t) {
				...
				return (
					...
					function t() {
						...
						e <= 1
							? ((this._flyToFrame = x(t, this)), this._move(this.unproject(s.add(r.subtract(s).multiplyBy(f(i) / l)), a), this.getScaleZoom(h / ((e = i), h * (p(m) / p(m + u * e))), a), { flyTo: !0 }))
			...
			_limitCenter: function (t, e, i) {
				var n, o;
				return !i || ((n = this.project(t, e)), (o = this.getSize().divideBy(2)), (o = new f(n.subtract(o), n.add(o))), (o = this._getBoundsOffset(o, i, e)), Math.abs(o.x) <= 1 && Math.abs(o.y) <= 1)
					? t
			...
			(A.include({
				...
				B.extend({
					...
					expand: function () {
						...
						return (
							t < this._section.clientHeight ? (M(this._section, "leaflet-control-layers-scrollbar"), (this._section.style.height = t + "px")) : z(this._section, "leaflet-control-layers-scrollbar"),
	...
	function Je(t, e, i) {
		...
		for (s = 0; s < 4; s++) {
			for (h = u[s], n = [], c = 0, o = (d = t.length) - 1; c < d; o = c++)
				(r = t[c]), (a = t[o]), r._code & h ? a._code & h || (((l = oi(a, r, h, e, i))._code = si(l, e)), n.push(l)) : (a._code & h && (((l = oi(a, r, h, e, i))._code = si(l, e)), n.push(l)), n.push(r));
			t = n;
		}
		return t;
	}
			...
			_initInteraction: function () {
				...
				this.options.interactive &&
					(M(this._icon, "leaflet-interactive"),
						...
						pi && ((t = this.options.draggable), this.dragging && ((t = this.dragging.enabled()), this.dragging.disable()), (this.dragging = new pi(this)), t && this.dragging.enable()));
			},
				...
				o.include({
					...
					_openPopup: function (t) {
						...
						this._popup &&
							...
							(Re(t),
								(e = t.layer || t.target),
								this._popup._source !== e || e instanceof fi ? ((this._popup._source = e), this.openPopup(t.latlng)) : this._map.hasLayer(this._popup) ? this.closePopup() : this.openPopup(t.latlng));
					},
						...
						var e,
							...
							i =
								"top" === s
									...
									: "bottom" === s
										? ((e = r / 2), 0)
										: ((e = "center" === s ? r / 2 : "right" === s ? 0 : "left" === s ? r : i.x < o.x ? ((s = "right"), 0) : ((s = "left"), r + 2 * (h.x + l.x))), a / 2);
