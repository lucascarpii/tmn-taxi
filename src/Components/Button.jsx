...
export function Button({
  ...
  const colorStyles = {
    blue: {
      solid: 'ring-blue-500 bg-blue-600 text-white hover:opacity-90',
      faded: 'ring-blue-500 bg-zinc-100 dark:bg-zinc-800 text-blue-500 border-2 border-zinc-200 dark:border-zinc-700 hover:opacity-90',
      bordered: 'ring-blue-500 text-blue-600 dark:text-blue-400 border-2 border-blue-600 hover:opacity-90',
    ...
    emerald: {
      ...
      faded: 'ring-emerald-500 bg-zinc-100 dark:bg-zinc-800 text-emerald-500 border-2 border-zinc-200 dark:border-zinc-700 hover:opacity-90',
      bordered: 'ring-emerald-500 text-emerald-600 dark:text-emerald-400 border-2 border-emerald-600 hover:opacity-90',
    ...
    red: {
      ...
      faded: 'ring-red-500 bg-zinc-100 dark:bg-zinc-800 text-red-500 border-2 border-zinc-200 dark:border-zinc-700 hover:opacity-90',
      bordered: 'ring-red-500 text-red-600 dark:text-red-400 border-2 border-red-600 hover:opacity-90',
    ...
    zinc: {
      ...
      faded: 'ring-zinc-500 bg-zinc-100 dark:bg-zinc-800 text-zinc-500 border-2 border-zinc-200 dark:border-zinc-700 hover:opacity-90',
      bordered: 'ring-zinc-500 text-zinc-600 dark:text-zinc-400 border-2 border-zinc-600 hover:opacity-90',
    ...
    yellow: {
      ...
      faded: 'ring-yellow-500 bg-zinc-100 dark:bg-zinc-800 text-yellow-500 border-2 border-zinc-200 dark:border-zinc-700 hover:opacity-90',
      bordered: 'ring-yellow-500 text-yellow-600 dark:text-yellow-400 border-2 border-yellow-600 hover:opacity-90',
    ...
    sky: {
      ...
      faded: 'ring-sky-500 bg-zinc-100 dark:bg-zinc-800 text-sky-500 border-2 border-zinc-200 dark:border-zinc-700 hover:opacity-90',
      bordered: 'ring-sky-500 text-sky-600 dark:text-sky-400 border-2 border-sky-600 hover:opacity-90',
    ...
    black: {
      ...
      faded: 'ring-zinc-400 bg-zinc-100 dark:bg-zinc-800 text-black border-2 border-zinc-200 dark:border-zinc-700 hover:opacity-90',
      bordered: 'ring-zinc-400 text-black dark:text-zinc-400 border-2 border-black hover:opacity-90',
  ...
  const buttonClasses = [
    'group relative inline-flex items-center justify-center select-none font-normal scale-100 active:scale-95 transition-all duration-200 focus:ring',
    sizeStyles[size],
